...
export const OPNET_CONFIG = {
  ...
  contractAddress: import.meta.env.VITE_CONTRACT_ADDRESS || 'opt1sqpns23f4e9e3hu6aweuh3d7shcana7r8js2cp702',
  vaultAddress: import.meta.env.VITE_VAULT_ADDRESS || 'opt1sqr2x7zlxx9qzz67tsph9g8afq049h8755urle8ka',
  tokenAddress: import.meta.env.VITE_TOKEN_ADDRESS || 'opt1sqz457yhf92353te4q8sakpryzcz7psqr75qhq507',
  tokenPubkey: import.meta.env.VITE_TOKEN_PUBKEY || '0x171e92c6a4191f64cb736a233e73ebcf20a654d67babeb83d0726f3f8b035383',
  tokenDecimals: 8,
  tokenSymbol: 'BPUSD',
  mintAmount: 1000,
